...
```{r Distribution of Tourist Overnight-Stay by Origin}
...
Not surprisingly, these where the regions with the most famous "Instagrammable" destinations such as:
...
Overall, the plot conveys a picture of the main touristic hotspots of Europe where tourists from abroad mostly arrive, However it might be biased as it does not consider other touristic accomodations such as Airbnb, mostly used by young Europeans.
...
```{r Distribution of Domestic Tourist Overnight-stay}
